    ...
    this.args = new util.Flist<Arg<Object>>()
        .list(
            new Arg<>(
                ...
                }), new Arg<>("help", null, "show this help information",
                Kind.Empty, (s) -> {
                  usage();
                  System.exit(1);
                }), new Arg<>("lex", null,
                ...
                }), new Arg<>("slp", "{args|interp|compile}",
                ...
                }), new Arg<>("visualize", "<bmp|pdf|ps|jpg>",
